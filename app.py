...
def export_all_data():
    ...
    for customer in customers:
        ...
        total_amount = sum((q.total_amount or 0) for q in customer_quotes)
...
def export_quote_pdf(quote_id):
    ...
    spacer_col = CONTENT_WIDTH - 7.5 * cm  # leaves 4cm label + 3.5cm value
    total_table = Table(total_rows, colWidths=[spacer_col, 4 * cm, 3.5 * cm])
    last_row = len(total_rows) - 1
    total_table.setStyle(TableStyle([
        ('ALIGN', (1, 0), (2, -1), 'RIGHT'),
